...
public class CalenderApi {
    public void cal(final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlStatic.SalonReservationday, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!responseObj.getString("error").equals("false")) {
                        ...
                        Gson gson = new Gson();
                        CalenderDate cla = gson.fromJson(response, CalenderDate.class);
                        callBack.onResponse(cla);
                    }
...

        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if (profile.getType().equals("salon")) {
                    ...
                    params.put("salon_id", profile.getUser().getId() + "");
                }
