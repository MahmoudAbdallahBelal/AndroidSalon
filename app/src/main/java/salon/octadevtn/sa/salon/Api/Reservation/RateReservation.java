...
import static salon.octadevtn.sa.salon.Utils.UrlStatic.rateReservation;
...
public class RateReservation {
    public void RateReservation(final String reservation_id, final String stars,
                                final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, rateReservation, new Response.Listener<String>() {
            @Override
