...
public class getPrice {
    public void price(final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlStatic.getPrice, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!responseObj.getString("error").equals("false")) {
                        ...
                        Gson gson = new Gson();
                        salon.octadevtn.sa.salon.Models.PriceCategory.Category[] currency = gson.fromJson(responseObj.getJSONArray("category").toString(),
                                salon.octadevtn.sa.salon.Models.PriceCategory.Category[].class);
