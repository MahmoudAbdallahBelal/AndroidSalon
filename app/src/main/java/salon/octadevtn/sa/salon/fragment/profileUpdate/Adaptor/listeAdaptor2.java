...
import salon.octadevtn.sa.salon.Models.PriceCategory.Category;
...
public class listeAdaptor2 extends RecyclerView.Adapter<listeAdaptor2.ViewHolder> {
    ...
    public listeAdaptor2(ArrayList<Category> itemList) {
