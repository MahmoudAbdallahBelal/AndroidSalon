...
import salon.octadevtn.sa.salon.Adaptor.PromotionAdaptorfilter;
import salon.octadevtn.sa.salon.Adaptor.UserAdaptor;
...
public class Reservation_home_salon extends Fragment implements TimePickerDialog.OnTimeSetListener {
    ...
    User user2;
    salon.octadevtn.sa.salon.Models.Promotion promotion2;
    Date selected = null;
    ...
    ArrayList<salon.octadevtn.sa.salon.Models.Promotion> promotion = new ArrayList<>();
    ...
    public Reservation_home_salon() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static Reservation_home_salon newInstance() {
        Reservation_home_salon fragment = new Reservation_home_salon();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            salon_name.setText(pro.getSalon().getUsername());
        } catch (ParsingException e) {
            e.printStackTrace();
        }

       //TODO if it comes from the salon
        user_name.setText(getString(R.string.client_name));
        ...
        user_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                d.setContentView(R.layout.dialog_liste_promotion);
                ...
                final UserAdaptor userAdaptor = new UserAdaptor(users);
                RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getActivity(), 1);
                recyclerView.setLayoutManager(mLayoutManager);
                recyclerView.setAdapter(userAdaptor);
                userAdaptor.setRecyclerClickListener(new UserAdaptor.RecyclerClickListener() {
                    @Override
                ...
                ((EditText) d.findViewById(R.id.search)).addTextChangedListener(new TextWatcher() {
                    @Override
                    public void onTextChanged(CharSequence s, int start, int before, int count) {

                        // TODO Auto-generated method stub
                        userAdaptor.getFilter().filter(s.toString());
        ...
        promotion_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog d = new Dialog(getActivity());
                d.setContentView(R.layout.dialog_liste_promotion);
                ...
                final PromotionAdaptorfilter userAdaptor = new PromotionAdaptorfilter(promotion);
                RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getActivity(), 1);
                recyclerView.setLayoutManager(mLayoutManager);
                recyclerView.setAdapter(userAdaptor);
                userAdaptor.setRecyclerClickListener(new PromotionAdaptorfilter.RecyclerClickListener() {
                    @Override
                    public void onClick(salon.octadevtn.sa.salon.Models.Promotion item) {
                        d.dismiss();

                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                        Date start = null;
                        try {
                            start = sdf.parse(item.getEndDate());
                        ...
                        if (d.after(start)) {
                            ...
                            promotion2 = item;
                            promotion_name.setText(item.getTitle());
                            Promotiondateliste.clear();
                            Promotiondateliste.add(new Promotiondate(promotion2.getStartDate(), promotion2.getEndDate()));
                        }
                    }
                });
                ((EditText) d.findViewById(R.id.search)).addTextChangedListener(new TextWatcher() {
...
*/
                if (selecteddate == true) {
                    ...
                    if (true) {
                        tpd.setAccentColor(getResources().getColor(R.color.color4));
...
*/
        ...
        new Promotion().getAlluser(new UniversalCallBack() {
                                       ...
                                       public void onResponse(Object result) {
                                           if (result != null && Reservation_home_salon.this.isVisible()) {
                                               ...
                                               User[] promotiondetail = (User[]) result;
                                               for (int i = 0; i < promotiondetail.length; i++)
                                                   users.add(promotiondetail[i]);
                                               api2();
                                           }
                                       }
        ...
        new Service().getpromotion(new UniversalCallBack() {
            ...
            public void onResponse(Object result) {
                if (result != null) {
                    ...
                    salon.octadevtn.sa.salon.Models.Promotion[] salon_cat = (salon.octadevtn.sa.salon.Models.Promotion[]) result;
                    for (int i = 0; i < salon_cat.length; i++) {
                        promotion.add(salon_cat[i]);
                    }
                    api3();
                } else {
                    showError();
    ...
    public void api3() {
        ...
        new ApiSalonProfile().salon(pro.getSalon().getId()
                , new UniversalCallBack() {
                    @Override
                    public void onResponse(Object result) {
                        if (result != null && Reservation_home_salon.this.isVisible()) {
