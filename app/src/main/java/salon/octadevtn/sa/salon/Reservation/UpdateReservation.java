...
public class UpdateReservation extends Fragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public static UpdateReservation newInstance(int id, String name, String sname, String date, String idR) {
        UpdateReservation fragment = new UpdateReservation();
        Bundle args = new Bundle();
        args.putInt(ARG_PARAM1, id);
        args.putString(ARG_PARAM2, name);
        args.putString(ARG_PARAM3, sname);
        args.putString(ARG_PARAM4, date);
        args.putString(ARG_PARAM5, idR);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_reservation_update, container, false);
        ...
        date.setText(mParam4.substring(0, 9));
        time.setText(mParam4.substring(10, mParam4.length()));
...
*/
    ...
    public void AddReservation() {
        pDialog.show();
        new AddReservation().UpdateReservation(user.getId() + "", salon.getSalon().getId() + "", mParam1, date.getText().toString(), dateseted, timeseted,
                mParam5, new UniversalCallBack() {
                    @Override
    ...
    public void api(String id) {
        ...
        new Promotion().getpromotion(Integer.parseInt(id)
                , new UniversalCallBack() {
                    @Override
                    public void onResponse(Object result) {
                        if (result != null && UpdateReservation.this.isVisible()) {
