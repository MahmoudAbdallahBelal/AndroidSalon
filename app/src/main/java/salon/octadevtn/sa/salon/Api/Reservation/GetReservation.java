...
import static salon.octadevtn.sa.salon.Utils.UrlStatic.getReservation;
...
public class GetReservation {
    public void GetReservation(final String reservation_id, final String status,
                               final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, getReservation, new Response.Listener<String>() {
            @Override
