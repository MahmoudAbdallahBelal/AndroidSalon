package salon.octadevtn.sa.salon.Utils.Circlebutton;
...
public class CircularProgressButton extends Button {
    ...
    private void initIdleStateDrawable() {
        ...
        mIdleStateDrawable.addState(StateSet.WILD_CARD, getResources().getDrawable(R.drawable.button_colored));
    }
    ...
    private StrokeGradientDrawable createDrawable2(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.button_colored).mutate();
        drawable.setCornerRadius(mCornerRadius);
        StrokeGradientDrawable strokeGradientDrawable = new StrokeGradientDrawable(drawable);
        strokeGradientDrawable.setStrokeWidth(mStrokeWidth);
