...
import salon.octadevtn.sa.salon.Adaptor.PromotionAdaptor;
 ...
 * {@link ListePromotionFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ListePromotionFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ListePromotionFragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    PromotionAdaptor mAdapter;
    SwipeRefreshLayout swipeRefreshLayout;
    RecyclerView recyclerView;
    LinearLayout lin;
    private List<Promotion> favList = new ArrayList<>();
    // TODO: Rename and change types of parameters
    private String mParam1;
    private String mParam2;
    private OnFragmentInteractionListener mListener;

    public ListePromotionFragment() {
    ...
    public static ListePromotionFragment newInstance(String param1, String param2) {
        ListePromotionFragment fragment = new ListePromotionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_promotion_liste, container, false);
        ...
        try {
            ...
            if (pro.getType().equals("salon"))
                ((TextView) v.findViewById(R.id.nodatatxt)).setText(getResources().getString(R.string.anypromotion2));
            else
                ((TextView) v.findViewById(R.id.nodatatxt)).setText(getResources().getString(R.string.anypromotion));
        ...
        mAdapter = new PromotionAdaptor(favList, getActivity(), recyclerView);
    ...
    public void showError() {
        ...
        if (Locale.getDefault().getLanguage() == "ar")
            gravity = RIGHT;
        if (ListePromotionFragment.this.isVisible())
