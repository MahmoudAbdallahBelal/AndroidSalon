...
import static salon.octadevtn.sa.salon.Utils.UrlStatic.Cancel_reservation;
...
public class CancelReservation {
    public void CancelReservation(final String reservation_id, final String cause, final String type_user,
                                  final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Cancel_reservation, new Response.Listener<String>() {
            @Override
