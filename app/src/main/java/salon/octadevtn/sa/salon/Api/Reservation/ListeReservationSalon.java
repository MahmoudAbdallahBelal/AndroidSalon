...
import static salon.octadevtn.sa.salon.Utils.UrlStatic.Liste_reservation_salon;
import static salon.octadevtn.sa.salon.Utils.UrlStatic.Liste_reservation_salondate;

/**
 * Created by Octadev on 7/14/2017.
 */

public class ListeReservationSalon {
    public void ListeReservation(final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Liste_reservation_salon, new Response.Listener<String>() {
            @Override
    ...
    public void ListeReservationdate(final String date, final UniversalCallBack callBack) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Liste_reservation_salondate, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("Liste_reservation", response.toString());
                try {
